...
const Navbar = ({ HomeRef, AboutRef, WorkRef, ProjectsRef, ContactRef }) => {
  ...
  return (
    <div ref={navbarRef} className="flex items-center justify-between w-full h-14 sticky top-0 z-10 text-white bg-gray-800 bg-opacity-60 backdrop-filter backdrop-blur-lg">
